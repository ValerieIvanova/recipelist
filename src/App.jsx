              ...
              <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                <div className="blog-box">
                  ...
                  <div className="blog-meta big-meta">
                    ...
                    <p>
                      Aenean suspendissea sodales urna. In at augue elit.
                      Vivamus enim nibh ac felis.
                    </p>
                    <small>
                      <a href="food-single.html" title="">
                        15 July, 2017
              ...
              <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                <div className="blog-box">
                  ...
                  <div className="blog-meta big-meta">
                    ...
                    <p>
                      Suspendissea sodales urna. In at augue elit. Vivamu ac
                      felis tempor odio.
                    </p>
                    <small>
                      <a href="food-single.html" title="">
              ...
              <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                <div className="blog-box">
                  ...
                  <div className="blog-meta big-meta">
                    ...
                    <p>
                      Suspendissea urna augue elit. Vivamus enim nibh, maximus
                      ac felis tempor odio.
                    </p>
                    <small>
                      <a href="food-single.html" title="">
                        13 July, 2017
              ...
              <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                <div className="blog-box">
                  ...
                  <div className="blog-meta big-meta">
                    ...
                    <p>
                      Aenean suspendissea sodales urna. In at augue elit.
                      Vivamus enim nibh, maximus ac felis.
                    </p>
                    <small>
                      <a href="food-single.html" title="">
                        11 July, 2017
